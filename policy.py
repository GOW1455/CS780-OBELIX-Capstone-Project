...
RANDOM_ACTION_RATE = 0.2
RANDOM_ACTION_PROBS = np.array([0.3, 0.15, 0.1, 0.15, 0.3], dtype=np.float32)
...
recovery_steps = 0
@torch.no_grad()
def policy_function(obs: np.ndarray, rng: np.random.Generator) -> str:
